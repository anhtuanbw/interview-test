Feature: Myer Account Management - Login and Profile Update
  ...
  Scenario: Log in with an existing account
    ...
    When the user enters username "chuyenspam13@gmail.com" and password "At12345618"
  ...
  Scenario: Update last name, and mobile number
    ...
    When the user updates their last name to "TuanTAT", and mobile number to "0411111127"
  ...
  Scenario: Update password
    ...
    And enter the old password is "At12345618" and new password is "At12345619"
  ...
  Scenario: Validate changes persist after logout and re-login
    ...
    When logs in with username "chuyenspam13@gmail.com" and password "At12345619"
    And the user navigate to the account settings page
    Then it should show lastname is "TuanTAT" and mobile number is "0411111127"